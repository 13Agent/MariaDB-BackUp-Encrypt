...
**Windows:** Скачать с [slproweb.com/products/Win32OpenSSL.html](https://slproweb.com/products/Win32OpenSSL.html) и добавить в PATH.
...
- `mysqldump-secure.cnf` содержит пароль в открытом виде — храните его в защищённом месте
- Убедитесь, что `private.pem` не попадает в репозиторий
- Рекомендуется выставить права 600 на файлы с чувствительными данными
